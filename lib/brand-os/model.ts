...
const FORMATS = {
  ...
  business_card_front: { label: "Carte de visite · recto", hint: "85 × 55 mm, fichier à plat", family: "print", aspectRatio: "3:2", resolution: "2k", kind: "print", nature: "artwork",
    direction: "flat print-ready design of the FRONT of a business card, 85 × 55 mm, seen perfectly flat and straight on, filling the whole frame with no rounded corners, no shadow, no desk, no hand, no scene: the brand logo as the main element with breathing space around it, a calm even area kept free for a name and a phone number, the brand palette only; no photograph" },
  business_card_back: { label: "Carte de visite · verso", hint: "Le dos de la même carte", family: "print", aspectRatio: "3:2", resolution: "2k", kind: "print", nature: "artwork",
    direction: "flat print-ready design of the BACK of a business card, 85 × 55 mm, seen perfectly flat and straight on, filling the whole frame with no rounded corners, no shadow, no desk, no scene: a brand surface built from the graphic system (pattern, signature shape or a plain brand colour), the logo small or absent, no text zone; no photograph" },
