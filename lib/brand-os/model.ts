...
const FORMATS = {
  ...
  // A business card is always two faces (Keyvan): the front carries the logo and a calm zone for the name,
  // the back is the brand's surface. Both are print files seen flat: never a photo of a card on a desk.
  // A business card is two faces made together (Keyvan): the front carries the logo, the back carries the
  // person's details typed in the Studio and drawn verbatim. Flat print files, never a photo of a card.
  business_card_front: { label: "Carte de visite", hint: "Recto + verso, 85 × 55 mm, fichiers à plat", family: "print", aspectRatio: "3:2", resolution: "2k", kind: "print", nature: "artwork",
    direction: "flat print-ready design of the front of a business card, 85 × 55 mm, seen perfectly flat and straight on, filling the whole frame, no rounded corners, no shadow, no desk, no scene: the brand logo as the single main element with breathing space, the brand palette only; no photograph" },
  business_card_back: { label: "Carte de visite · verso", hint: "Le dos de la même carte", family: "print", aspectRatio: "3:2", resolution: "2k", kind: "print", nature: "artwork",
    direction: "flat print-ready design of the back of a business card, 85 × 55 mm, seen perfectly flat and straight on, filling the whole frame, no rounded corners, no shadow, no desk, no scene: a contact block, the logo small, the brand palette only; no photograph", legacy: true },
