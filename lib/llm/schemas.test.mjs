...
import { CAROUSEL_PLAN_SCHEMA, FEED_PLAN_SCHEMA, TILE_COPY_SCHEMA } from "../tiles/model.ts";
import { BRAND_OS_EXTENSION_SCHEMA, BRAND_OS_SCHEMA, IMAGE_PROMPT_SCHEMA, RULES_SCHEMA } from "../brand-os/model.ts";
import { CAPTION_SCHEMA } from "../calendar/model.ts";
import { MEDIUM_BRIEF_SCHEMA } from "../expertise/model.ts";
...
test("tous les schémas envoyés au LLM sont stricts", () => {
  const schemas = { BRAND_OS_SCHEMA, BRAND_OS_EXTENSION_SCHEMA, FEED_PLAN_SCHEMA, CAROUSEL_PLAN_SCHEMA, TILE_COPY_SCHEMA, IMAGE_PROMPT_SCHEMA, RULES_SCHEMA, CAPTION_SCHEMA, MEDIUM_BRIEF_SCHEMA };
